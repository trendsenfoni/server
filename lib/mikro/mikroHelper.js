...
FROM (
SELECT Y.MagazaNo, Y.Magaza, ROUND(SUM(Y.Tutar),2) as Satis,ROUND(SUM(Y.Vergi),2) as Vergi, ROUND(SUM(CASE WHEN ISNULL(Y.SasFiyat,0)>0 THEN ISNULL(Y.SasFiyat,0) ELSE Y.SonAlis END * Y.Miktar),2) as Maliyet FROM 
...
CASE WHEN ISNULL(Maliyet,0)>0 THEN ROUND((Satis-Maliyet)/Maliyet,2) ELSE 1 END as KarOran
FROM (
SELECT Y.Kod, Y.Isim, ROUND(SUM(Y.Tutar),2) as Satis, ROUND(SUM(Y.Vergi),2) as Vergi, ROUND(SUM(CASE WHEN ISNULL(Y.SasFiyat,0)>0 THEN ISNULL(Y.SasFiyat,0) ELSE Y.SonAlis END * Y.Miktar),2) as Maliyet FROM 
